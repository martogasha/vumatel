                    ...
                    <div class="text-95 col-sm-6 align-self-start d-sm-flex justify-content-end">
                        ...
                        <div class="text-grey-m2">
                            ...
                            <div class="my-2"><i class="fa fa-circle text-blue-m2 text-xs mr-1"></i> <span class="text-600 text-90">Issue Date:</span> {{$receipt->date}}</div>
                                <div class="my-2"><i class="fa fa-circle text-blue-m2 text-xs mr-1"></i> <span class="text-600 text-90">Payment method:</span> <span class="badge badge-success badge-pill px-25">Cash</span></div>
                        </div>
                    </div>
                    <!-- /.col -->
                </div>
                ...
                <div class="mt-4">
                    ...
                    <div class="text-95 text-secondary-d3">
                        <div class="row mb-2 mb-sm-0 py-25">
                            <div class="d-none d-sm-block col-1"></div>
                            <div class="col-9 col-sm-5">Invoiced</div>
                            <div class="d-none d-sm-block col-2"></div>
                            <div class="d-none d-sm-block col-2 text-95"></div>
                            <div class="col-2 text-secondary-d2">SH{{$receipt->invoice->amount}}</div>
                        </div>
                    </div>
                    <div class="text-95 text-secondary-d3">
                        <div class="row mb-2 mb-sm-0 py-25">

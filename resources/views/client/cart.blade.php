...
<title>Cart - Japcom Networks</title>
                    ...
                    <div class="col-12 col-md-7 col-lg-9">
                        ...
                        <div class="ps-shopping__table">
                            <table class="table ps-table ps-table--product">
                                ...
                                <tr>
                                    <td class="ps-product__remove"> <a href="{{url('cartRemove',$product['item']['id'])}}"><i class="icon-cross"></i></a></td>
                                    <td class="ps-product__thumbnail"><a class="ps-product__image" href="product1.html">
                                            <figure><img src="{{asset('uploads/product/'.$product['item']['photo'])}}" alt></figure>
                                        </a></td>
                                    <td class="ps-product__name"> <a href="product1.html">{{$product['item']['name']}}</a></td>
                                    <td class="ps-product__meta"> <span class="ps-product__price sale">Ksh:{{$product['item']['amount']}}</span>
                                    </td>
                                    <td class="ps-product__quantity">
                                        <div class="def-number-input number-input safari_only">
                                            <a href="{{url('cartReduceByOne',$product['item']['id'])}}"><button class="minus"><i class="icon-minus"></i></button></a>
                                            <input class="quantity" min="0" name="quantity" value="{{$product['quantity']}}" type="number">
                                            <a href="{{url('addByOne',$product['item']['id'])}}"><button class="plus"><i class="icon-plus"></i></button></a>
                                        </div>
                                    </td>
                                    <td class="ps-product__subtotal">Ksh:{{$product['item']['amount'] * $product['quantity']}}</td>
                                </tr>
                    ...
                    <div class="col-12 col-md-5 col-lg-3">
                        ...
                        <div class="ps-shopping__box">
                            <div class="ps-shopping__row">
                                ...
                                @if(isset($totalPrice))
                                <div class="ps-shopping__price">Ksh:{{$totalPrice}}</div>
                                @endif
                            </div>
                            ...
                            <div class="ps-shopping__checkout"><a class="ps-btn ps-btn--warning" href="{{url('checkout')}}">Proceed to checkout</a><a class="ps-shopping__link" href="category-list.html">Continue To Shopping</a></div>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-8">
                                <div class="ps-footer--contact">
                                    ...
                                    <hr>
                                    <p><a class="ps-footer__email" href="http://nouthemes.net/cdn-cgi/l/email-protection#2e4d41405a4f4d5a6e4b564f435e424b004d4143"> <i class="icon-envelope"></i><span class="__cf_email__" data-cfemail="85e6eaebf1e4e6f1c5e0fde4e8f5e9e0abe6eae8">[email&#160;protected]</span> </a></p>
                                </div>
                            </div>
                        </div>
                    </div>
...
<!-- Mirrored from nouthemes.net/html/mymedi/shopping-cart.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 29 Jun 2021 05:22:49 GMT -->
</html>

                ...
                <div class="col-12 col-md-6">
                    <form action="http://nouthemes.net/html/mymedi/do_action" method="post">
                        <div class="ps-form--review">
                            <h2 class="ps-form__title">Hello, {{\Illuminate\Support\Facades\Auth::user()->first_name}} {{\Illuminate\Support\Facades\Auth::user()->last_name}}</h2>
                            <div class="ps-form__group">
                                <label class="ps-form__label">First Name *</label>
                                <input class="form-control ps-form__input" value="{{\Illuminate\Support\Facades\Auth::user()->first_name}}" type="text">
                            </div>
                            <div class="ps-form__group">
                                <label class="ps-form__label">Last Name *</label>
                                <input class="form-control ps-form__input" value="{{\Illuminate\Support\Facades\Auth::user()->last_name}}" type="text">
                            </div>
                            <div class="ps-form__group">
                                <label class="ps-form__label">Email *</label>
                                <input class="form-control ps-form__input" value="{{\Illuminate\Support\Facades\Auth::user()->email}}" type="email">
                            </div>
                        </div>
                    </form>
                </div>
                <div class="col-12 col-md-6">
                        <div class="ps-form--review">
                            ...
                            <div class="ps-form__group">
                                ...
                                <input class="form-control ps-form__input" value="{{\Illuminate\Support\Facades\Auth::user()->phone}}" type="text">
                            </div>
                            <div class="ps-form__group">
                            ...
                            <div class="ps-form__submit">
                                <form action="{{route('logout')}}" method="post">
                                    @csrf
                                    <button type="submit" class="ps-btn ps-btn--warning">Logout</button>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-8">
                                <div class="ps-footer--contact">
                                    ...
                                    <hr>
                                    <p><a class="ps-footer__email" href="http://nouthemes.net/cdn-cgi/l/email-protection#8ae9e5e4feebe9fecaeff2ebe7fae6efa4e9e5e7"> <i class="icon-envelope"></i><span class="__cf_email__" data-cfemail="65060a0b1104061125001d04081509004b060a08">[email&#160;protected]</span> </a></p>
                                </div>
                            </div>
                        </div>
                    </div>
...
<!-- Mirrored from nouthemes.net/html/mymedi/my-account.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 29 Jun 2021 05:35:35 GMT -->
</html>

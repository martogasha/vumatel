    ...
    public function handle()
    {
        ...
        foreach($ones as $one){
                $oneDay = $one->one_day_before;
                        ...
                        'message' => 'Dear customer, your internet subscription expires on '.date('d/F/Y',strtotime($one->user->due_date)).'. To renew, kindly pay Ksh "" '.$one->user->package_amount.' using
PAYBILL: 4311304
